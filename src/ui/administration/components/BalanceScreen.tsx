...
import BalancePdfDialog from "./BalancePdfDialog";
...
function BalanceScreen() {
  ...
  const [openDialog, setOpenDialog] = useState<'balancePdfViewer' | null>(null);
  ...
  const handleExportBalancePdf = () => {
    setOpenDialog('balancePdfViewer');
  };
  ...
  return (
    <>
      <div className={openDialog ? "balance-screen-container filter-blur" : "balance-screen-container"}>
          ...
          readyToDisplayInform ?
            <>
              ...
              <div className="button-options">
                <PosButton
                  label={t('screens.balance.exportPdfLabel')}
                  icon={<FaRegFilePdf />}
      ...
      <dialog className='balance-pdf-dialog' ref={pdfDialogRef} open={openDialog === 'balancePdfViewer'}>
        <BalancePdfDialog
          isShowed={openDialog === 'balancePdfViewer'}
          startDate={startDate}
          endDate={endDate}
          sales={sales}
          egresses={egresses}
